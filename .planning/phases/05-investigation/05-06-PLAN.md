...
<task type="auto">
  ...
  <files>src/data/testTown.ts, src/hooks/useNPCMemory.tsx, src/types/npc.ts</files>
  <action>
...
- Ensure NPCs have the full NPC type including optional knowledge and conflictThresholds fields
