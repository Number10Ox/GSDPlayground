...
must_haves:
  truths:
    - "NPC knowledge is filtered server-side before LLM prompt construction"
    - "LLM responses stream to client for perceived performance"
    - "System prompts enforce DitV period voice and brevity constraints"
    - "Inner voice templates provide stat-based interjections without API cost"
  artifacts:
